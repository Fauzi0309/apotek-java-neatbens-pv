 ...
 * @author fauzi
 */
public class pelanggan1 extends javax.swing.JFrame {
 private Connection conn = new Koneksi_Apotek().connect();
    ...
    protected void datatable(){
        Object[] Baris ={"ID Pasien","Nama","Jenis Kelamin","No. Telepon","Alamat"};
...
try {
    String sql = "update pelanggan set id=?, nmplg=?, jenis=?, telepon=?,alamat=? where id='"+txtid.getText()+"'";
    PreparedStatement stat = conn.prepareStatement(sql);
    stat.setString(1, txtid.getText());
    stat.setString(2, txtnm.getText());
    stat.setString(3, jenis);
...
datatable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pelanggan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pelanggan1().setVisible(true);
            }
        });
    }
